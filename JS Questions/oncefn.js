...
// console.log(onceAdd(2, 3)); // 5 (fn executed)
// console.log(onceAdd(4, 5)); // 5 (cached result)
// console.log(onceAdd(10, 20)); // 5 (cached result)
// Function with no arguments
// function greet() {
...
// console.log(onceGreet()); // "Hello Namaste Dev!"
// console.log(onceGreet()); // "Hello Namaste Dev!"
...
// console.log(onceDoNothing()); // undefined
// console.log(onceDoNothing()); // undefined
